...
exports.ExplanationAgent = exports.RiskReasoningAgent = exports.PFZAgent = exports.GeospatialAgent = exports.OceanIntelligenceAgent = exports.WeatherHazardAgent = exports.MarineDataAgent = exports.PlannerAgent = void 0;
const AgentContext_1 = require("./AgentContext");
const ToolRegistry_1 = require("./ToolRegistry");
const obsTool = new ToolRegistry_1.QueryObservationsTool();
const alertsTool = new ToolRegistry_1.QueryAlertsTool();
const pfzTool = new ToolRegistry_1.QueryPFZsTool();
const bufferTool = new ToolRegistry_1.GeospatialBufferTool();
/**
 * 1. Planner Agent
 * Intent parser and task decomposer
 */
class PlannerAgent extends AgentContext_1.BaseAgent {
    name = 'Planner Agent';
    async run(context) {
        context.trace.push({
            agent: this.name,
        ...
        else if (queryLower.includes('fishing') ||
 ...
 */
class MarineDataAgent extends AgentContext_1.BaseAgent {
...
exports.MarineDataAgent = MarineDataAgent;
/**
 * 3. Weather/Hazard Agent
 * Checks active weather or spill alert boundaries
 */
class WeatherHazardAgent extends AgentContext_1.BaseAgent {
...
exports.WeatherHazardAgent = WeatherHazardAgent;
/**
 * 4. Ocean Intelligence Agent
 * Integrates intelligence historical matches
 */
class OceanIntelligenceAgent extends AgentContext_1.BaseAgent {
...
exports.OceanIntelligenceAgent = OceanIntelligenceAgent;
/**
 * 5. Geospatial Agent
 * Performs polygon buffers and coordinate distance offsets
 */
class GeospatialAgent extends AgentContext_1.BaseAgent {
...
exports.GeospatialAgent = GeospatialAgent;
/**
 * 6. PFZ Agent
 * Fetches Potential Fishing Zone metadata
 */
class PFZAgent extends AgentContext_1.BaseAgent {
    name = 'PFZ Agent';
    async run(context) {
        context.trace.push({
            agent: this.name,
...
exports.PFZAgent = PFZAgent;
/**
 * 7. Risk/Reasoning Agent
 * Weighs facts and computes overall risk and confidence
 */
class RiskReasoningAgent extends AgentContext_1.BaseAgent {
    ...
    async run(context) {
        ...
        // Confidence solver
        let confidence = 0.65;
        if (context.accumulatedData.marineData?.some((o) => o.verification?.status === 'VERIFIED')) {
            confidence += 0.2;
        }
...
exports.RiskReasoningAgent = RiskReasoningAgent;
/**
 * 8. Explanation Agent
 * Compiles recommendations, sources, layers, and formulates final answer
 */
class ExplanationAgent extends AgentContext_1.BaseAgent {
    ...
    async run(context) {
        ...
        if (context.accumulatedData.marineData) {
            context.accumulatedData.marineData.forEach((d, idx) => {
                sources.push({
        ...
        if (context.accumulatedData.weatherData) {
            context.accumulatedData.weatherData.forEach((w, idx) => {
                sources.push({
