...
export const PortalInvestigationsPage: React.FC = () => {
  ...
  const cases = INITIAL_INVESTIGATIONS;
  const [activeCase, setActiveCase] = useState<InvestigationCase>(INITIAL_INVESTIGATIONS[0]);
  ...
  useEffect(() => {
    ...
    const loadEvidence = async () => {
      try {
        ...
        console.error('Failed to load live evidence for case:', err);
      }
    };
    loadEvidence();
